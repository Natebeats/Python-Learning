...
public class FollowerModel extends ModelChangeSupport {
    ...
    public void setFollower(List<String> follower) {
        ...
        changeSupport.firePropertyChange("follower", old, follower);
    }
