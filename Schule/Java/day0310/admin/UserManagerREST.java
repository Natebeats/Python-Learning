...
public class UserManagerREST implements InterfaceCallback, ControllerInterface {
    private final String baseUrl = Constants.BASE_URL + "users";
    private HttpClient httpClient;
    private Gson gson;
	private static UserManagerREST instance;
    ...
    public static UserManagerREST getInstance() {
    	if(instance == null) {
    		instance = new UserManagerREST();
    		instance.init();
    	}
    	return instance;
    }
